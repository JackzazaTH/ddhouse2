...
<button className="btn-outline" onClick={()=>{
          ...
          const pros = listProjects()
          const urls = ['/','/แบบบ้าน','/ผลงาน','/รีวิวลูกค้า','/คำถามที่พบบ่อย','/บทความ']
            .concat(arts.map(a => '/บทความ/' + encodeURIComponent(a.slug)))
            .concat(pros.map(p => '/ผลงาน/' + encodeURIComponent(p.slug)))
